...
export async function proxy(request: NextRequest) {
  ...
  const protectedRoots = ["/workspace","/matters","/rag-inbox","/intake","/interactions","/digitisation","/law-bank","/finance","/forms","/people","/studio","/system"];
  const isProtectedPage = pathname === "/" || protectedRoots.some((root) => pathname.startsWith(root));
  const protectedApis = ["/api/workspace","/api/matters","/api/intake","/api/interactions","/api/law-bank","/api/legal-sources","/api/finance","/api/forms","/api/operations","/api/session"];
...
export const config = { matcher: ["/","/workspace/:path*","/matters/:path*","/rag-inbox/:path*","/intake/:path*","/interactions/:path*","/digitisation/:path*","/law-bank/:path*","/finance/:path*","/forms/:path*","/people/:path*","/studio/:path*","/system/:path*","/auth/:path*","/onboarding/:path*","/api/workspace/:path*","/api/matters/:path*","/api/intake/:path*","/api/interactions/:path*","/api/law-bank/:path*","/api/legal-sources/:path*","/api/finance/:path*","/api/forms/:path*","/api/operations/:path*","/api/onboarding/:path*","/api/session/:path*"] };
